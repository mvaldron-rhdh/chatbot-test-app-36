...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-36](https://github.com/mvaldron-rhdh/chatbot-test-app-36)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-36-gitops](https://github.com/mvaldron-rhdh/chatbot-test-app-36-gitops)

# **Usage**

To access the chatbot-test-app-36 application that was deployed using the Software Template, complete the following instructions:
